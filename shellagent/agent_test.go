...
func TestProtocolFilesystemAndExecParity(t *testing.T) {
	...
	if features["multiplexedChannels"] != true || features["reliableStreams"] != false || features["datagrams"] != false || features["rawBridgeStreams"] != false || features["filesystemStreams"] != false || features["fragments"] != false {
